...
class User extends CI_Controller
{
    ...
    public function edit()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            //cek jika ada gambar yg akan diuoload
            ...
            if ($upload_image) {
                ...
                $config['upload_path'] = './asset/img/image/';
                ...
                if ($this->upload->do_upload('image')) {
                    ...
                    if ($old_image != 'ci.jpg') {
                        unlink(FCPATH . 'asset/img/image/' . $old_image);
                    }
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!password_verify($current_password, $data['user']['password'])) {
                ...
                if ($current_password == $new_password) {
                    ...
                    $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Kata sandi diubah</div>');
                    redirect('user/changepassword');
                }
            }
        }
